...
import { editorRefs, useEditorStore } from "@/stores/editorStore";
...
function M({ model, position, rotation = 0, scale = 1 }: P) {
  ...
  const id = useRef(
    `${model
      .split("/")
      .pop()
      ?.replace(/\.gl(b|tf)$/, "")}@${position[0]},${position[2]}`,
  ).current;
...
function usePirateTexture() {
  return useMemo(() => {
    const tex = new THREE.TextureLoader().load(
      "/models/pirate/Textures/colormap.png",
    );
    tex.flipY = false;
...
function useWatercraftTexture() {
  return useMemo(() => {
    const tex = new THREE.TextureLoader().load(
      "/models/watercraft/Textures/colormap.png",
    );
    tex.flipY = false;
    tex.colorSpace = THREE.SRGBColorSpace;
    return tex;
...
const BIOME_COLORS: Record<string, [number, number, number]> = {
  ...
  forest: [0.3, 0.58, 0.32], // dark green
  beach: [0.99, 0.9, 0.55], // #fde68a — sand
...
function CenterPlaza() {
  ...
  return (
    <group>
      ...
      <Tex
        model="/models/pirate/cannon.glb"
        position={[-1.5, 0, 2]}
        rotation={Math.PI}
        scale={1}
        texture={tex}
  ...
  return (
    <group>
      ...
      <group position={[30, 0, 40]} rotation={[0, 0.68, 0]}>
        <Tex
          model="/models/pirate/structure-platform-dock.glb"
          position={[0, 0, 0]}
          scale={1}
          texture={pirateTex}
        />
        ...
        />
        <Tex
          model="/models/pirate/structure-platform-dock-small.glb"
          position={[0, 0, 2]}
          scale={1}
          texture={pirateTex}
        />
      ...
      {/* Boats at the dock */}
      <Tex
        model="/models/pirate/boat-row-small.glb"
        position={[34, -0.4, 43]}
        rotation={0.7}
        scale={1}
        texture={pirateTex}
      />
      <Tex
        model="/models/watercraft/boat-fishing-small.glb"
        position={[32, -0.5, 44]}
        rotation={1.0}
        scale={1}
        texture={waterTex}
      ...
      <Tex
        model="/models/pirate/barrel.glb"
        position={[27, 0, 38]}
        scale={1}
        texture={pirateTex}
      />
      ...
      <Tex
        model="/models/pirate/barrel.glb"
        position={[26.8, 0, 39.2]}
        rotation={1.1}
        scale={1}
        texture={pirateTex}
      />
      <Tex
        model="/models/pirate/crate.glb"
        position={[26, 0, 38.5]}
        rotation={0.3}
        scale={1}
        texture={pirateTex}
      />
      <Tex
        model="/models/pirate/crate-bottles.glb"
        position={[26.3, 0, 39.3]}
        rotation={0.8}
        scale={1}
        texture={pirateTex}
      />
      ...
      {/* ── South beach camp ── */}
      <M
        model="/models/nature/campfire_stones.glb"
        position={[0, 0, 38]}
        scale={2.2}
      />
      <M
        model="/models/nature/log.glb"
        position={[1, 0, 37]}
        rotation={0.5}
        scale={2.2}
      />
      ...
      />
      <Tex
        model="/models/pirate/structure.glb"
        position={[-4, 0, 40]}
        rotation={0.2}
        scale={1}
        texture={pirateTex}
      />
      <Tex
        model="/models/pirate/structure-roof.glb"
        position={[-4, 0, 40]}
        rotation={0.2}
        scale={1}
        texture={pirateTex}
      ...
      {/* Boat at east dock */}
      <Tex
        model="/models/pirate/boat-row-large.glb"
        position={[46, -0.4, 8]}
        rotation={1.5}
        scale={1}
        texture={pirateTex}
      ...
      <Tex
        model="/models/pirate/ship-wreck.glb"
        position={[50, -0.7, 44]}
        rotation={0.4}
        scale={1.3}
        texture={pirateTex}
      />
      <Tex
        model="/models/watercraft/buoy.glb"
        position={[48, -0.6, 20]}
        scale={1}
        texture={waterTex}
      />
      ...
      />
      <Tex
        model="/models/watercraft/buoy-flag.glb"
        position={[56, -0.6, -5]}
        scale={1}
        texture={waterTex}
      />
...
function WestVillage() {
  ...
  return (
    <group>
      ...
      />
      <Tex
        model="/models/pirate/structure-fence.glb"
        position={[-26, 0, 6]}
        rotation={0.8}
        scale={1}
        texture={tex}
...
function Trees() {
  ...
  const palms: P[] = [
    ...
    {
      model: "/models/pirate/palm-bend.glb",
      position: [20, 0, 38],
      rotation: 0.9,
      scale: 1,
    },
    ...
    {
      model: "/models/pirate/palm-straight.glb",
      position: [36, 0, 32],
      rotation: 1.7,
      scale: 0.9,
    },
    {
      model: "/models/pirate/palm-detailed-bend.glb",
      position: [24, 0, 36],
      rotation: 0.5,
      scale: 1,
    },
  ...
  const inlandTrees: P[] = [
    // Outer ring trees (away from village clearing)
    {
      model: "/models/nature/tree_oak.glb",
      position: [-8, 0, -26],
      rotation: 1.5,
      scale: 3.3,
    },
    {
      model: "/models/nature/tree_detailed.glb",
      position: [6, 0, -26],
      rotation: 1.2,
      scale: 3.0,
    },
    ...
    {
      model: "/models/nature/tree_fat.glb",
      position: [34, 0, 14],
      rotation: 1.5,
      scale: 3.0,
    },
...
function CoastalRocks() {
  ...
  const sandyRocks: P[] = [
    {
      model: "/models/pirate/rocks-sand-a.glb",
      position: [40, 0, 6],
      rotation: 0.5,
      scale: 1,
    },
    ...
    {
      model: "/models/pirate/rocks-sand-b.glb",
      position: [34, 0, -26],
      rotation: 1.8,
      scale: 1,
    },
    ...
    {
      model: "/models/pirate/rocks-sand-c.glb",
      position: [18, 0, 40],
      rotation: 2.4,
      scale: 1,
    },
  ...
  const natureRocks: P[] = [
    {
      model: "/models/nature/rock_largeA.glb",
      position: [-12, 0, 2],
      rotation: 0.5,
      scale: 2.4,
    },
    ...
    {
      model: "/models/nature/rock_smallA.glb",
      position: [6, 0, -6],
      rotation: 1.1,
      scale: 3.0,
    },
    ...
    {
      model: "/models/nature/rock_tallA.glb",
      position: [26, 0, -26],
      rotation: 1.8,
      scale: 2.1,
    },
...
const VEGETATION: P[] = [
  ...
  {
    model: "/models/nature/plant_bushLarge.glb",
    position: [-16, 0, 16],
    scale: 2.1,
  },
  {
  ...
  {
    model: "/models/nature/flower_purpleA.glb",
    position: [-6, 0, -24],
    scale: 3,
  },
  {
    model: "/models/nature/flower_yellowA.glb",
    position: [12, 0, 10],
    scale: 3,
  },
  {
  ...
  {
    model: "/models/nature/grass_large.glb",
    position: [0, 0, -22],
    scale: 2.4,
  },
  ...
  // Stumps
  {
    model: "/models/nature/stump_round.glb",
    position: [-28, 0, -18],
    scale: 2.7,
  },
  ...
  return (
    <group>
      ...
      <Bobbing speed={0.6} amplitude={0.15} phase={0}>
        <Tex
          model="/models/watercraft/boat-sail-a.glb"
          position={[-60, -0.5, -30]}
          rotation={0.8}
          scale={1.2}
          texture={waterTex}
...
function ForestBarrier() {
  const items = useMemo(() => {
    ...
    // Dense tree belt around the island in a "C" shape:
    // - Skip south (z > 25) → beach opening
    // - Skip west corridor (x < -38, |z| < 6) → path to wild beach
    // - 4 concentric rings, step 0.08 for good density without perf hit

    const rings = [24, 30, 36, 42];
    for (const baseR of rings) {
      for (let angle = 0; angle < Math.PI * 2; angle += 0.08) {
        const r = baseR + seededRandom() * 5;
        const x = Math.cos(angle) * r + (seededRandom() - 0.5) * 3;
        const z = Math.sin(angle) * r + (seededRandom() - 0.5) * 3;

        // "C" shape: skip south opening (beach area)
        if (z > 25) continue;

        // West corridor gap: passage to wild beach
        if (x < -38 && z > -6 && z < 6) continue;

        if (!isInsideLand(x, z)) continue;
        const shore = distanceToShore(x, z);
        if (shore < 3) continue;
        const biome = getBiome(x, z);
        if (biome === "beach" || biome === "mountain" || biome === "village")
          continue;

        const isBush = seededRandom() < 0.15;
        const model = isBush
          ? FOREST_BUSH_MODELS[
              Math.floor(seededRandom() * FOREST_BUSH_MODELS.length)
            ]
          : FOREST_TREE_MODELS[
              Math.floor(seededRandom() * FOREST_TREE_MODELS.length)
            ];
        ...
        result.push({
          ...
          scale: isBush
            ? 2.0 + seededRandom() * 1.0
            : 1.6 + seededRandom() * 0.8,
        });
      }
    }
...
function MountainBarrier() {
  const items = useMemo(() => {
    ...
    // Dense rock wall along the north coast
    for (let x = -42; x < 38; x += 6) {
      for (let z = -50; z < -20; z += 6) {
        const jx = x + (seededRandom() - 0.5) * 4;
        const jz = z + (seededRandom() - 0.5) * 4;
        if (!isInsideLand(jx, jz)) continue;
        if (getBiome(jx, jz) !== "mountain") continue;

        const isHill = seededRandom() < 0.4;
        const model = isHill
...
/* ── Wild Beach — small hidden cove on the west coast ──────── */
